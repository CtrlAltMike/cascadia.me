...
(function() {
  ...
  function getEndpoint() {
    const endpointMeta = document.querySelector('meta[name="cascadia-feedback-endpoint"]');
    return endpointMeta && endpointMeta.content ? endpointMeta.content.trim() : '';
  }

  function getPageTitle() {
    return document.title.replace(/\s+\|\s+Cascadia\.me$/, '').trim();
  }
